...
SECRET_KEY = 'django-insecure-!9@2arg#^lbfu$lu#q))j9+_0sz-a-55_u%+=va9(6pnzv*a-s'
...
ASGI_APPLICATION = 'parcel_management.asgi.application'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'parcels/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
